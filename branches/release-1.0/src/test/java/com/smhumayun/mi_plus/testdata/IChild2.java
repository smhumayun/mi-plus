...
import com.smhumayun.mi_plus.MIObjectScope;
import com.smhumayun.mi_plus.MISupport;

@MISupport(parentClasses = {ParentOne.class, ParentTwo.class}
        , scope = MIObjectScope.PROTOTYPE_CONTAINER_SINGLETON_COMPOSED)
public interface IChild2 extends IParentOne, IParentTwo {
}
