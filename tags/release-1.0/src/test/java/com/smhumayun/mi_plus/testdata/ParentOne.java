...
public class ParentOne implements IParentOne {

    public void parentOneMethod() {
        System.out.println("ParentOne.parentOneMethod");
    }

    public String sameMethodSignature() {
        System.out.println("ParentOne.sameMethodSignature");
